...
import 'auth/application/bloc/sign_in_bloc/signin_bloc.dart' as _i33;
import 'auth/application/bloc/sign_up_bloc/signup_bloc.dart' as _i34;
...
import 'auth/domain/usecases/auth_usecases.dart' as _i31;
import 'auth/domain/usecases/forgot_password_usecase.dart' as _i27;
import 'auth/domain/usecases/login_usecase.dart' as _i29;
import 'auth/domain/usecases/request_otp_usecase.dart' as _i30;
...
import 'common/application/auth_bloc/auth_bloc.dart' as _i36;
import 'common/application/user_bloc/user_bloc.dart' as _i35;
...
import 'common/domain/usecases/common_usecases.dart' as _i32;
import 'common/domain/usecases/get_stored_user_usecase.dart' as _i28;
...
import 'common/infrastructure/register_module.dart' as _i37;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i27.ForgotPasswordUseCase>(
      () => _i27.ForgotPasswordUseCase(get<_i19.SignInRepository>()));
  gh.factory<_i28.GetStoredUserUseCase>(
      () => _i28.GetStoredUserUseCase(get<_i24.UserRepository>()));
  gh.factory<_i29.LoginUseCase>(
      () => _i29.LoginUseCase(get<_i19.SignInRepository>()));
  gh.factory<_i30.RequestOtpUseCase>(
      () => _i30.RequestOtpUseCase(get<_i21.SignUpRepository>()));
  gh.factory<_i31.AuthUseCases>(() => _i31.AuthUseCases(
      signInUsecase: get<_i20.SignInUsecase>(),
      signUpUsecase: get<_i22.SignUpUsecase>(),
      requestOtpUseCase: get<_i30.RequestOtpUseCase>(),
      submitOtpUseCase: get<_i23.SubmitOtpUseCase>(),
      startCountDownUseCase: get<_i13.StartCountDownUseCase>(),
      forgotPasswordUseCase: get<_i27.ForgotPasswordUseCase>()));
  gh.factory<_i32.CommonUseCases>(() => _i32.CommonUseCases(
      getStoredUserUseCase: get<_i28.GetStoredUserUseCase>(),
      authenticateUseCase: get<_i26.AuthenticateUseCase>()));
  gh.factory<_i33.SignInBloc>(() => _i33.SignInBloc(get<_i31.AuthUseCases>()));
  gh.factory<_i34.SignUpBloc>(() => _i34.SignUpBloc(get<_i31.AuthUseCases>()));
  gh.factory<_i35.UserBloc>(() => _i35.UserBloc(get<_i32.CommonUseCases>()));
  gh.factory<_i36.AuthBloc>(() => _i36.AuthBloc(get<_i32.CommonUseCases>()));
  return get;
}
