...
import 'package:chopper/chopper.dart' as _i30;
...
import 'account/application/account_bloc/account_bloc.dart' as _i71;
...
import 'account/domain/usecases/edit_user_usecase.dart' as _i51;
...
import 'auth/application/bloc/sign_in_bloc/signin_bloc.dart' as _i68;
import 'auth/application/bloc/sign_up_bloc/signup_bloc.dart' as _i69;
...
import 'auth/domain/usecases/confirm_password_usecase.dart' as _i49;
import 'auth/domain/usecases/forgot_password_usecase.dart' as _i52;
...
import 'common/application/auth_bloc/auth_bloc.dart' as _i72;
import 'common/application/user_bloc/user_bloc.dart' as _i70;
...
import 'common/domain/repositories/user_repository.dart' as _i29;
import 'common/domain/usecases/authenticate_usecase.dart' as _i47;
import 'common/domain/usecases/base_usecases.dart' as _i21;
import 'common/domain/usecases/check_authenticate_usecase.dart' as _i48;
import 'common/domain/usecases/common_usecases.dart' as _i64;
import 'common/domain/usecases/get_stored_user_stream_usecase.dart' as _i33;
import 'common/domain/usecases/get_stored_user_usecase.dart' as _i34;
...
import 'common/infrastructure/chopper/interceptors/places_interceptor.dart'
    as _i28;
import 'common/infrastructure/register_module.dart' as _i73;
...
import 'delivery/domain/repositories/delivery_repository.dart' as _i31;
import 'delivery/domain/usecases/choose_duration_usecase.dart' as _i3;
import 'delivery/domain/usecases/delivery_usecases.dart' as _i50;
import 'delivery/domain/usecases/get_location_districts_usecase.dart' as _i32;
import 'delivery/domain/usecases/proceed_to_payment_usecase.dart' as _i37;
import 'delivery/domain/usecases/search_usecase.dart' as _i38;
import 'parcels/application/parcels_bloc/parcel_bloc.dart' as _i66;
import 'parcels/domain/repositories/parcel_repository.dart' as _i35;
import 'parcels/domain/usecases/get_history_usecase.dart' as _i53;
import 'parcels/domain/usecases/parcel_usecases.dart' as _i57;
import 'payment/application/payment_bloc/payment_bloc.dart' as _i67;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i29.UserRepository>(
      () => _i29.UserRepository(get<_i22.CommonStorageInterface>()));
  gh.factory<_i30.ChopperClient>(() => registerModule.client(get<_i4.Client>(),
      get<String>(instanceName: 'baseUrl'), get<_i24.JwtAuthenticator>()));
  gh.factory<_i31.DeliveryRepository>(() => _i31.DeliveryRepository(
      get<_i30.ChopperClient>(), get<_i22.CommonStorageInterface>()));
  gh.factory<_i32.GetLocationDistrictUseCase>(
      () => _i32.GetLocationDistrictUseCase(get<_i31.DeliveryRepository>()));
  gh.factory<_i33.GetStoredUserStreamUseCase>(
      () => _i33.GetStoredUserStreamUseCase(get<_i29.UserRepository>()));
  gh.factory<_i34.GetStoredUserUseCase>(
      () => _i34.GetStoredUserUseCase(get<_i29.UserRepository>()));
  ...
  gh.factory<_i36.PaymentRepository>(() => _i36.PaymentRepository(
      ...
      get<_i30.ChopperClient>(),
      get<_i22.CommonStorageInterface>()));
  gh.factory<_i37.ProceedToPaymentUseCase>(
      () => _i37.ProceedToPaymentUseCase(get<_i31.DeliveryRepository>()));
  gh.factory<_i38.SearchUsecase>(
      () => _i38.SearchUsecase(get<_i31.DeliveryRepository>()));
  ...
  gh.factory<_i41.SignUpRepository>(() => _i41.SignUpRepository(
      get<_i30.ChopperClient>(), get<_i18.AuthStorageInterface>()));
  ...
  gh.factory<_i47.AuthenticateUseCase>(
      () => _i47.AuthenticateUseCase(get<_i46.AuthRepository>()));
  gh.factory<_i48.CheckAuthenticateUseCase>(
      () => _i48.CheckAuthenticateUseCase(get<_i46.AuthRepository>()));
  gh.factory<_i49.ConfirmPasswordUseCase>(
      () => _i49.ConfirmPasswordUseCase(get<_i39.SignInRepository>()));
  gh.factory<_i50.DeliveryUseCases>(() => _i50.DeliveryUseCases(
      chooseDurationUseCase: get<_i3.ChooseDurationUseCase>(),
      getLocationDistrictUseCase: get<_i32.GetLocationDistrictUseCase>(),
      proceedToPaymentUseCase: get<_i37.ProceedToPaymentUseCase>(),
      searchUsecase: get<_i38.SearchUsecase>()));
  gh.factory<_i51.EditUserUseCase>(
      () => _i51.EditUserUseCase(get<_i45.AccountRepository>()));
  gh.factory<_i52.ForgotPasswordUseCase>(
      () => _i52.ForgotPasswordUseCase(get<_i39.SignInRepository>()));
  gh.factory<_i53.GetHistoryUseCase>(
      () => _i53.GetHistoryUseCase(get<_i35.ParcelRepository>()));
  gh.factory<_i54.LogoutUseCase>(
      () => _i54.LogoutUseCase(get<_i46.AuthRepository>()));
  gh.factory<_i55.MakePaymentUseCase>(
      () => _i55.MakePaymentUseCase(get<_i36.PaymentRepository>()));
  gh.factory<_i56.OpenMapUseCase>(
      () => _i56.OpenMapUseCase(get<_i36.PaymentRepository>()));
  gh.factory<_i57.ParcelUseCases>(() =>
      _i57.ParcelUseCases(getHistoryUseCase: get<_i53.GetHistoryUseCase>()));
  ...
  gh.factory<_i59.RequestOtpUseCase>(
      () => _i59.RequestOtpUseCase(get<_i41.SignUpRepository>()));
  gh.factory<_i60.ResetPasswordUseCase>(
      () => _i60.ResetPasswordUseCase(get<_i45.AccountRepository>()));
  gh.factory<_i61.UploadPhotoUsecase>(
      () => _i61.UploadPhotoUsecase(get<_i45.AccountRepository>()));
  gh.factory<_i62.AccountUseCases>(() => _i62.AccountUseCases(
      editUserUseCase: get<_i51.EditUserUseCase>(),
  ...
  gh.factory<_i63.AuthUseCases>(() => _i63.AuthUseCases(
      ...
      confirmPasswordUseCase: get<_i49.ConfirmPasswordUseCase>(),
      forgotPasswordUseCase: get<_i52.ForgotPasswordUseCase>(),
      submitPasswordOtpUseCase: get<_i44.SubmitPasswordOtpUseCase>()));
  gh.factory<_i64.CommonUseCases>(() => _i64.CommonUseCases(
      getStoredUserUseCase: get<_i34.GetStoredUserUseCase>(),
      ...
      getStoredUserStreamUseCase: get<_i33.GetStoredUserStreamUseCase>()));
  gh.factory<_i65.DeliveryBloc>(
      () => _i65.DeliveryBloc(get<_i50.DeliveryUseCases>()));
  gh.factory<_i66.ParcelBloc>(
      () => _i66.ParcelBloc(get<_i57.ParcelUseCases>()));
  gh.factory<_i67.PaymentBloc>(
      () => _i67.PaymentBloc(get<_i58.PaymentUseCases>()));
  gh.factory<_i68.SignInBloc>(() => _i68.SignInBloc(get<_i63.AuthUseCases>()));
  gh.factory<_i69.SignUpBloc>(() => _i69.SignUpBloc(get<_i63.AuthUseCases>()));
  gh.factory<_i70.UserBloc>(() => _i70.UserBloc(get<_i64.CommonUseCases>()));
  gh.factory<_i71.AccountBloc>(
      () => _i71.AccountBloc(get<_i62.AccountUseCases>()));
  gh.factory<_i72.AuthBloc>(() => _i72.AuthBloc(get<_i64.CommonUseCases>()));
  return get;
}
