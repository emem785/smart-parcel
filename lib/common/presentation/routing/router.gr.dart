...
import 'package:smart_parcel/parcels/presentation/self_storage_parcel/self_storage_parcel.dart'
    as _i27;
import 'package:smart_parcel/payment/domain/models/payment_data.dart' as _i33;
...
class SubmitPasswordOtpRoute
  ...
  SubmitPasswordOtpRoute({_i31.Key? key, required String email})
      : super(name,
            path: '/submitPasswordOtp',
...
class ConfirmEmailRoute extends _i12.PageRouteInfo<ConfirmEmailRouteArgs> {
  ConfirmEmailRoute(
      {_i31.Key? key, required String email, required String password})
      : super(name,
            path: '/confirmEmail',
...
class ConfirmPasswordRoute
  ...
  ConfirmPasswordRoute({_i31.Key? key, required String email})
      : super(name,
...
class SelectLocationRoute extends _i12.PageRouteInfo<SelectLocationRouteArgs> {
  SelectLocationRoute(
      {_i31.Key? key, required _i32.CenterDistrict centerDistrict})
      : super(name,
            path: 'selectLocation',
...
class SelectLocationRouteArgs {
  ...
  final _i32.CenterDistrict centerDistrict;
}
...
class ReceiptRoute extends _i12.PageRouteInfo<ReceiptRouteArgs> {
  ReceiptRoute({_i31.Key? key, required _i33.PaymentData paymentData})
      : super(name,
            path: 'receiptPage',
...
class ReceiptRouteArgs {
  ...
  final _i33.PaymentData paymentData;
}
...
class SelfParcelDetailsRoute
  ...
  SelfParcelDetailsRoute({required _i34.SelfStorage selfStorage, _i31.Key? key})
      : super(name,
            path: 'selfDetailsPage',
            args:
...
class SelfParcelDetailsRouteArgs {
  ...
  final _i34.SelfStorage selfStorage;
...
class CustomerParcelDetailsRoute
  ...
  CustomerParcelDetailsRoute(
      {required _i35.CustomerToCustomer customerToCustomer, _i31.Key? key})
      : super(name,
            path: 'customerDetailsPage',
...
class CustomerParcelDetailsRouteArgs {
  ...
  final _i35.CustomerToCustomer customerToCustomer;
...
class CustomerParcelRoute extends _i12.PageRouteInfo<CustomerParcelRouteArgs> {
  CustomerParcelRoute({_i31.Key? key})
      : super(name,
...
class SelfStorageParcelRoute
  ...
  SelfStorageParcelRoute({_i31.Key? key})
      : super(name,
